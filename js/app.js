...
const SCHEMA = {
  ...
  acessos: { title: 'Matriz de acessos', sub: 'Quem tem acesso a quê, com justificativa e aprovador', singular: 'acesso',
    fields: [
      ...
      { k: 'tipo', l: 'Conta', t: 'select', o: OPT.tipoConta, table: 1 },
      { k: 'natureza', l: 'Natureza da conta', t: 'select', o: OPT.naturezaConta, table: 1, pill: 1 },
      { k: 'objeto', l: 'Banco', t: 'bancoref', fillServidor: 1, table: 1 },
...
const I18N = {
  en: {
    ...
    'Bancos': 'Databases', 'Banco': 'Database',
    'Conta': 'Account', 'Natureza da conta': 'Account nature',
    'Usuário': 'User', 'Serviço': 'Service',
